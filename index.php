...
// Fetch news items from news_card table
try {
    $stmt = $pdo->query("SELECT id, title, content, category, image_path, likes, created_at FROM news_card ORDER BY created_at DESC LIMIT 10");
...
?>
>>>>>>> 6204cbdf672d4cd0b96b632494cc4543c84be8e2
<html lang="en">
<head>
    <meta charset="utf-8" />
            ...
            <ul>
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <li>
                        ...
                        <?php if (isset($_SESSION['anonymous']) && $_SESSION['anonymous']): ?>
                            (Anonymous Mode)
                        <?php endif; ?>
                    </li>
                    <li>
                ...
                <li>
                    <a href="anonymous.php" class="post-btn" aria-label="Toggle anonymous mode">
                        <?php echo isset($_SESSION['anonymous']) && $_SESSION['anonymous'] ? 'Exit Anonymous Mode' : 'Anonymous Mode'; ?>
                    </a>
                </li>
            </ul>
